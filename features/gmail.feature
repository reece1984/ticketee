Feature: Gmail
	...
	Background:
		Given there are the following users:
		  ...
		  | jamesreece84@googlemail.com      | Carol1ne               |
		And ActionMailer delivers via SMTP
		
		Given there is a project called "TextMate 2"
		And "alice@ticketee.com" can view the "TextMate 2" project
		And "jamesreece84@googlemail.com" can view the "TextMate 2" project
		And "jamesreece84@googlemail.com" has created a ticket for this project:
			| title                | description             |
